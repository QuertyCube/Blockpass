...
//         EventLibrary.TicketInfo[] memory tickets = new EventLibrary.TicketInfo[](1);
//         tickets[0] = EventLibrary.TicketInfo("VIP", 100 ether, 100);

//         EventLibrary.EventParams memory params = EventLibrary.EventParams({
...
//         EventLibrary.EventParams memory invalidParams = EventLibrary.EventParams({
...
//         EventLibrary.TicketInfo[] memory tickets = new EventLibrary.TicketInfo[](0);
